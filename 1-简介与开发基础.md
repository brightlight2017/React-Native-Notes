...
7.属性
  ...
  `var msg=<h1 width="10px">我是susu</h1>`

  React.createElement("h1",{width:"10px"},"我是susu")
...
8.延展属性
 ...
 `<h1 {...props} foo="2" >欢迎关注我</h1>` 转换成：

React.createElement("h1",React.__spread({},props,{foo:"2"}),"欢迎关注我")
...
`<div>{{_html:'<h1>我是susu，欢迎关注我</h1>'}}</div>`
